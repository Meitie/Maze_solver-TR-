...
def create_obstacles(min_x, min_y, max_x, max_y):
    """
    It takes the draw lines from a previous function and hardcode draws out each level of obstacles, and returns a list of the obstacles that were created
    """
...
def draw_lines(old_x, old_y, new_x, new_y):
    """
    Takes the global obstacles and draws a loop through co-ords given from the old x,y until the new x,y at a 5 interval space (accounting for the squares)
    :returns the obstacles lists:
    """
    global obstacles
